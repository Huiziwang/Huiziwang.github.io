...
[Research Statement](https://github.com/user-attachments/files/21476348/Huizi_s_Research_Statement.pdf)
...
- The model/variable selection process of our methods is similar to the e-probe curation procedure and can be used to simplify the Microbe Finder data generation procedure. 
